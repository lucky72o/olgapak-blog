...
Worth saying plainly: all three of these are a pairing problem, not a paper problem. The same notebook behaves completely differently depending on what you write with, so it's worth picking [the best pens for note taking](/best-pens-for-note-taking) alongside the paper rather than after it. Highlighters are the other half of that pairing, and [the best highlighters for studying](/best-highlighters-for-studying) are ranked partly on how they behave on thin paper.
...
These are the do-everything picks: one notebook, any kind of note, no fuss. If you want a single answer to "which one should I buy?", start here. It also helps to give the notebook a permanent spot rather than a pile, which is one of the decisions in my [desk setup](/aesthetic-desk-setup) guide.
