...
![Woman at a desk midweek calmly crossing out tasks and re-prioritizing her week](../../blog-ops/assets/how-to-plan-your-week/midweek-reset-scene.png)
...
That's really it. The tools matter far less than picking a small set and sticking with them. If you'd rather run the whole thing on paper, [starting a bullet journal](/bullet-journal-for-beginners) gives you the same three pieces in one notebook, and if the problem is executing the plan rather than making it, [a Pomodoro timer](/pomodoro-technique) is the cheapest thing that helps.
